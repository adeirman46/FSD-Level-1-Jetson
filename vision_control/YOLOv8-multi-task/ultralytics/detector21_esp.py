...
class Visualizer:
    ...
    @staticmethod
    def draw_distance_and_velocity(frame, distance, velocity, actual_velocity, brake):
        ...
        cv2.putText(frame, f'Brake: {brake:.2f}', (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
...
class MainApplication:
    ...
    def process_frame(self):
        ...
        cv2.putText(combined_img, f'FPS: {fps:.2f}', (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
